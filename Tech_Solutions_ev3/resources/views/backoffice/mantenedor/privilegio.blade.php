...
@section('title', 'Proyecto EV3 | ' . $titulo['singular'])
                ...
                <table id="projects-table" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Nombre</th>
                            <th class="text-center">Icono + Color</th>
                        ...
                        @foreach ($registros as $registro)
                            <tr>
                                ...
                                <td class="text-center">
                                    <label class="btn btn-{{ $registro->color }}"><i
                                            class="{{ $registro->icono }}"></i></label>
                                </td>
                                <td>
                                    {{ $registro->created_at }}
        ...
        function open_modal(_id, _accion) {
            ...
            switch (_accion) {
                ...
                case 'editar':
                    ...
                    propiedades.form.action = @json(route('privilegios.update', 'xxx')).split('xxx')[0] + _id;
                ...
                case 'encender':
                    ...
                    propiedades.form.action = @json(route('privilegios.enable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'apagar':
                    ...
                    propiedades.form.action = @json(route('privilegios.disable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'eliminar':
                    ...
                    propiedades.form.action = @json(route('privilegios.delete', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
