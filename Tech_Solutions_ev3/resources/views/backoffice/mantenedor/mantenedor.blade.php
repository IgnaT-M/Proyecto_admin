                    ...
                    <tbody>
                        @foreach ($registros as $registro)
                            <tr>
                                ...
                                <td>
                                    <i style="font-size: 32px" class="{{ $registro->icono }}"></i>
                                    {{ $registro->icono }}
                                </td>
                                <td>
                                    {{ $registro->ruta }}
        ...
        function open_modal(_id, _accion) {
            ...
            switch (_accion) {
                ...
                case 'editar':
                    ...
                    propiedades.form.action = @json(route('mantenedores.update', 'xxx')).split('xxx')[0] + _id;
                ...
                case 'encender':
                    ...
                    propiedades.form.action = @json(route('mantenedores.enable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'apagar':
                    ...
                    propiedades.form.action = @json(route('mantenedores.disable', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
                ...
                case 'eliminar':
                    ...
                    propiedades.form.action = @json(route('mantenedores.delete', 'xxx')).split('xxx')[0] + _id;
                    propiedades.form.method = 'post';
