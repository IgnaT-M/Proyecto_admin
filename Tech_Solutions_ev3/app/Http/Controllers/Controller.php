...
abstract class Controller
{
    public $mensajes = [
        ...
        'usuario_name.required' => 'El nombre es obligatorio 8D',
        'usuario_email.required' => 'El email es obligatorio 8D',
        ...
        'privilegio_nombre.required' => 'El nombre del privilegio es obligatorio',
        'privilegio_nombre.unique' => 'El nombre ya existe :(',
        //crear/actualizar rol por backoffice
        'rol_nombre.required' => 'El nombre del rol obligatorio :(',
